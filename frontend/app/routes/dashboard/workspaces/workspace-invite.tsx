...
import { useAcceptGenerateInviteMutation, useAcceptInviteByTokenMutation, useGetWorkspaceInviteDetailsQuery } from "hooks/use-workspace";
...
const WorkspaceInvite = () => {
  ...
  const { data: workspace, isLoading } = useGetWorkspaceInviteDetailsQuery(workspaceId!) as { data: Workspace; isLoading: boolean };
